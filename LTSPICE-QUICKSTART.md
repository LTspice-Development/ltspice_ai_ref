...
- Training materials: http://www.analog.com/ltspice (videos, articles, tips)
...
**Download**: https://LTspice.analog.com/download/latest/LTspice64.msi
...
1. Draw a circuit (or open an example: **Help > Open Examples...**)
